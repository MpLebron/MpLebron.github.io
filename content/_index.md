    ...
    content:
      ...
      text: |-
        <div class="pm-home-section">
          <div class="pm-section-label pm-section-label-sky">Research Overview</div>
          <div class="pm-board pm-board-overview">
            <div class="pm-overview-grid">
              <div class="pm-overview-copy">
                <p class="pm-overview-kicker">Building intelligent geographic modeling systems that connect knowledge, model services, and reproducible workflows.</p>
                <p>I work at the intersection of intelligent geographic modeling, geospatial information services, and AI for Science. My research focuses on how domain knowledge, model resources, and computational services can be organized into reusable workflows for geographic analysis, simulation, and decision support.</p>
                <p>Recent work includes knowledge-driven hydrological sensitivity analysis, open knowledge frameworks for geoscientific models, and interactive research software such as PyGeoModel and OpenGeoLab. Across these projects, I aim to make geographic modeling more open, reproducible, and easier to use in real scientific settings.</p>
                <div class="pm-chip-row">
                  <span class="pm-chip pm-chip-static">Intelligent Geographic Modeling</span>
                  <span class="pm-chip pm-chip-static">Geospatial Information Services</span>
                  <span class="pm-chip pm-chip-static">AI for Science</span>
                  <span class="pm-chip pm-chip-static">Open Science Infrastructure</span>
                </div>
              </div>
              <div class="pm-overview-side">
                <div class="pm-overview-panel">
                  <h3>Current Themes</h3>
                  <div class="pm-overview-theme-list">
                    <div class="pm-overview-theme">
                      <h4>Knowledge and Models</h4>
                      <p>Representing geographic model knowledge so model discovery, configuration, and reuse become more structured.</p>
                    </div>
                    <div class="pm-overview-theme">
                      <h4>Service-Oriented Workflows</h4>
                      <p>Connecting models with distributed online services and reproducible execution environments for scalable analysis.</p>
                    </div>
                    <div class="pm-overview-theme">
                      <h4>Interactive Research Software</h4>
                      <p>Building Jupyter and agent-facing tools that lower the barrier to geographic modeling and simulation.</p>
                    </div>
                  </div>
                </div>
                <div class="pm-overview-metrics">
                  <div class="pm-overview-metric">
                    <strong>10+</strong>
